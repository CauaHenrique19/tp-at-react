...
var Tabs = React9.forwardRef(function Tabs2(inProps, ref) {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime9.jsx)(ScrollButtonComponent, {
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime9.jsx)(ScrollButtonComponent, {
      slots: {
  ...
  const indicator = (0, import_jsx_runtime9.jsx)(TabsIndicator, {
    ...TabIndicatorProps,
  ...
  return (0, import_jsx_runtime9.jsxs)(TabsRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component,
...
//# sourceMappingURL=chunk-WHHFTXRT.js.map
